import { combineReducers, createStore } from 'c/lwcRedux';
import reducers from 'c/productReducers';
import { api, LightningElement } from 'lwc';

export default class ProductContainter extends LightningElement {
    @api store;
    initialize(){
